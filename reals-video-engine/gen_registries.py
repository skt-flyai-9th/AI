"""Registry JSON generator. Font assets are registered with real sha256 values."""
import hashlib
import json
import pathlib
...
effect_registry = {
    ...
    "effects": {
        ...
        "SPEED": {
            "effect_id": "SPEED",
            "support_level": "BASIC",
            "renderer_key": "setpts_v1",
            "allowed_params": {"multiplier": {"min": 0.5, "max": 2.0}},
            "version": 1,
        },
        "COLOR_TONE": {
            ...
            "support_level": "BASIC",
            "renderer_key": "eq_v1",
            "allowed_params": {"tone": {"enum": ["NATURAL", "WARM", "COOL", "VIVID"]}},
            "version": 1,
        },
        "SMOOTH_ZOOM": {
            "effect_id": "SMOOTH_ZOOM",
            "support_level": "CONDITIONAL",
            "renderer_key": "zoompan_v2",
            "required_capability": "RAM_10GB",
            "fallback": "PUNCH_ZOOM",
            "allowed_params": {"scale_end": {"min": 1.0, "max": 1.2}},
            "version": 1,
        },
        "SHAKE": {
            "effect_id": "SHAKE",
            "support_level": "BASIC",
            "renderer_key": "transform_shake_v1",
            "allowed_params": {
                "start_ms": {"min": 0, "max": 60000},
                "end_ms": {"min": 1, "max": 60000},
                "amplitude_x_pct": {"min": 0.0, "max": 0.03},
                "amplitude_y_pct": {"min": 0.0, "max": 0.03},
                "rotation_deg": {"min": -3.0, "max": 3.0},
                "scale": {"min": 1.0, "max": 1.05},
                "frequency_hz": {"min": 1.0, "max": 20.0},
                "damping": {"enum": [True, False]},
            },
            "version": 1,
        },
        "VIBRATION": {
            "effect_id": "VIBRATION",
            "support_level": "BASIC",
            "renderer_key": "transform_vibration_v1",
            "allowed_params": {
                "start_ms": {"min": 0, "max": 60000},
                "end_ms": {"min": 1, "max": 60000},
                "amplitude_x_pct": {"min": 0.0, "max": 0.015},
                "amplitude_y_pct": {"min": 0.0, "max": 0.015},
                "rotation_deg": {"min": -1.0, "max": 1.0},
                "scale": {"min": 1.0, "max": 1.03},
                "frequency_hz": {"min": 8.0, "max": 30.0},
                "damping": {"enum": [True, False]},
            },
            "version": 1,
        },
        "ROTATION": {
            "effect_id": "ROTATION",
            "support_level": "BASIC",
            "renderer_key": "transform_rotation_v1",
            "allowed_params": {
                "start_ms": {"min": 0, "max": 60000},
                "end_ms": {"min": 1, "max": 60000},
                "rotation_deg": {"min": -3.0, "max": 3.0},
        ...
        "ZOOM": {
            "effect_id": "ZOOM",
            "support_level": "BASIC",
            "renderer_key": "zoompan_timed_v1",
            "allowed_params": {
                "start_ms": {"min": 0, "max": 60000},
                "end_ms": {"min": 1, "max": 60000},
                "scale_start": {"min": 1.0, "max": 1.2},
                "scale_end": {"min": 1.0, "max": 1.2},
            },
            "version": 1,
        },
        "POSITION_MOVE": {
            "effect_id": "POSITION_MOVE",
            "support_level": "BASIC",
            "renderer_key": "transform_position_v1",
            "allowed_params": {
                "start_ms": {"min": 0, "max": 60000},
                "end_ms": {"min": 1, "max": 60000},
                "translate_x_pct": {"min": -0.08, "max": 0.08},
                "translate_y_pct": {"min": -0.08, "max": 0.08},
                "scale": {"min": 1.0, "max": 1.05},
            },
            "version": 1,
        },
        ...
        "COLOR": {
            "effect_id": "COLOR",
            "support_level": "BASIC",
            "renderer_key": "eq_timed_v1",
            "allowed_params": {
                "start_ms": {"min": 0, "max": 60000},
                "end_ms": {"min": 1, "max": 60000},
                "tone": {"enum": ["NATURAL", "WARM", "COOL", "VIVID"]},
            },
            "version": 1,
        },
    },
    ...
    "transitions": ["NONE", "HARD_CUT", "FLASH_WHITE"],
}
...
audio_mix = {
    "policies": {
        "SFX_ONLY_V1": {
            ...
            "bgm_policy": "NONE",
            "fallback_audio_mode": "SILENT",
        },
        "SILENT_V1": {
            "audio_mix_policy_id": "SILENT_V1",
            "final_audio_policy": "SILENT",
            "sample_rate": 48000,
            "max_sfx_per_video": 0,
            "min_sfx_gap_ms": 0,
            "true_peak_limit_db": -1.0,
...
manifest = {
    "template_bundle_id": "tb_local_dev_001",
    "template_version": "4.2-frame-accurate.dev",
    "files": {},
}
...
for name, data in [
    ...
    ("safe_area_profiles", safe_area),
    ("render_profiles", render_profiles),
    ("audio_mix_policy", audio_mix),
