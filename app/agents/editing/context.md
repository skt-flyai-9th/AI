...
You receive a confirmed project, the exact selected video-editing DB version, timestamped
...
- Captions must describe or promote only facts present in project/database/video context.
