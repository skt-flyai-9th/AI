...
from app.services.store_trade_area_context import save_store_trade_area_insight
...
def create_trade_area_insight(
    payload: TradeAreaInsightRequest,
    ...
    """
    result = build_trade_area_insight(payload.store)
    save_store_trade_area_insight(db, store=payload.store, result=result)
    return result
